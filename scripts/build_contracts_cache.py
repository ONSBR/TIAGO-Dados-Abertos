...
como {"__date__": iso} / {"__datetime__": iso} e o contracts.py decodifica de
...
# A MESMA funcao que o carregador usa para validar: build e boot nunca divergem.
from mcp_tiago_dados_abertos.catalogo.contracts import yaml_manifest  # noqa: E402
