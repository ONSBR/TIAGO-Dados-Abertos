# -*- coding: utf-8 -*-
"""Os contratos parseados UMA vez, com o mesmo loader que o servidor usa.

Dois desperdicios somados faziam a suite de corpus levar minutos:

  - `yaml.safe_load` nunca usa o loader em C. No corpus sao 10,1s contra
...
def corpus_docs():
    """[(nome_do_dataset, doc)] dos contratos, na ordem do nome.
