...
que vem ANTES dela:
    ...
    infra -> catalogo -> execucao -> motor -> resposta -> tools

Este teste congela isso. Sem ele, a organizacao degrada em silencio — bastaria um
`from ..tools import` dentro de `motor/` e a fronteira sumiria sem ninguem ver.
...
CAMADA_DE = {
    ...
    "catalog": "catalogo", "retrieval": "catalogo", "ranking": "catalogo",
    # motor: pergunta -> SQL
    "semantics_engine": "motor", "context": "motor", "pruning": "motor", "unit_advisor": "motor",
    # motor/engine/: o semantics_engine fatiado
    "normalizacao": "motor", "contagem": "motor", "plano": "motor", "parametros": "motor", "ambiguidade": "motor", "metricas": "motor", "patterns": "motor", "template": "motor", "fallback": "motor", "planejador": "motor",
    # execucao
    "validator": "execucao", "db": "execucao", "rate_limiter": "execucao",
    # resposta: SQL executado -> fatos tipados
    "result_schema": "resposta", "lineage": "resposta", "computed_facts": "resposta",
    "fact_packet": "resposta", "confidence": "resposta",
    "provenance": "resposta",
    # tools e servidor: orquestram
    "server": "tools", "buscar": "tools",
    "descrever_dataset": "tools", "executar_sql": "tools", "listar_datasets": "tools",
}
ORDEM = ["infra", "catalogo", "motor", "execucao", "resposta", "tools"]
    ...
    for n in ast.walk(tree):
        if isinstance(n, ast.ImportFrom) and n.module:
            ...
            if n.level or partes[0] == PKG:
                folha = partes[-1]
                if folha in ORDEM or folha in ("tools", "engine", PKG):  # from pkg.<camada> import X -> X e' o modulo
