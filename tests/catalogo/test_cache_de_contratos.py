...
from mcp_tiago_dados_abertos.catalogo.catalog import _cache_valido
...
class TestCatalogGuard:
    """Teste da rede de seguranca no catalog.py (Mudanca 2b).
    ...
    def _isolate_catalog_module(self):
        ...
        from mcp_tiago_dados_abertos.catalogo import catalog
    ...
    def test_catalog_rejeita_cache_parcial(self, workspace_tmp_path, monkeypatch):
        """catalog.load_all_contracts com cache parcial (n_docs errado) nao serve docs truncados."""
        import importlib
        ...
        result = catalog.load_all_contracts()
    ...
    def test_catalog_aceita_cache_valido(self, workspace_tmp_path, monkeypatch):
        """catalog.load_all_contracts com cache valido carrega os docs."""
        import importlib
        ...
        docs = [
            {
                ...
                "data": {
                    ...
                    "periodoCoberturaInicio": datetime.date(2020, 1, 1),
                    "periodoCoberturaFim": datetime.date(2024, 12, 31),
                },
            },
            {
                "orgao": "ons",
        ...
        docs = [
            {
                ...
                "data": {
                    "name": "carga-energia",
                    "customProperties": [
                        {"property": "periodoCoberturaInicio", "value": datetime.date(2020, 1, 1)},
                    ],
                },
            },
        ]
...
name: mini-teste
customProperties:
  - property: periodoCoberturaInicio
    value: 2020-01-01
schema: []
"""
