...
# Teto de tamanho do SQL, em caracteres, aplicado ANTES de qualquer parse: o parser
# custa tempo proporcional ao texto, e sem teto uma consulta enorme ocuparia o
# processo por segundos. 64 KB e dezenas de vezes o maior SQL legitimo do corpus.
MAX_SQL_CHARS = int(os.getenv("MCP_MAX_SQL_CHARS", "65536"))
